...
class CompaniesOverviewScreen extends StatefulWidget {
  const CompaniesOverviewScreen({super.key});

  @override
  State<CompaniesOverviewScreen> createState() =>
      _CompaniesOverviewScreenState();
}

class _CompaniesOverviewScreenState extends State<CompaniesOverviewScreen> {
    ...
    return Skeletonizer(
      ...
      child: Column(
        children: [
          FHeader.nested(
            title: Skeleton.keep(
              child: Text('Empresas', style: context.theme.typography.base),
            ),
            prefixes: [
              FButton.icon(
